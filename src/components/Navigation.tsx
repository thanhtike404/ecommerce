...
export default function Navigation() {
	...
	return (
		<nav
			className={`fixed top-0 w-full flex items-start justify-between px-5 md:px-14 lg:px-24 py-2 md:py-4 z-10 bg-black/60  backdrop-blur-md${
				navMenuOpen ? "bg-black/60 backdrop-blur-md h-screen" : ""
			}`}
		>
			<Link
				href={"/"}
